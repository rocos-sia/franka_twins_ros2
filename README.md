...
[▶️ Watch the Demo Video](https://github.com/rocos-sia/franka_twins_ros2/blob/main/image/README/gui.mp4)
...
## 🚀 代码示例运行
**备注**
- 运动控制器的代码位于 `/home/landau/Documents/franka_twins_ros2` 目录下。
- 视觉主机的代码位于 `/home/sun/Documents/GitHub/franka_twins_ros2` 目录下。
...
```bash
ros2 launch franka_twins_bringup cola_bringup.launch.py
```
